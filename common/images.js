function qualityToImage(quality) {
    return `https://wiki.factorio.com/images/Quality_${quality}.png`;
}

function toImageUrl(itemName) {
    // Dictionary mapping Factorio item names to their image URLs on the wiki
    const FACTORIO_ITEMS_32px = {
        ...
        'small lamp': 'Lamp.png/32px-Lamp.png',
        ...
        'iron gear wheel': 'Iron_gear_wheel.png/32px-Iron_gear_wheel.png',
        ...
        'stone wall': 'Wall.png/32px-Wall.png',
        ...
        'ice melting': 'Ice_melting.png/32px-Ice_melting.png',
        'plastic bar': 'Plastic_bar.png/32px-Plastic_bar.png',
        'casting low density structure': 'Casting_low_density_structure.png/32px-Casting_low_density_structure.png',
        'sulfur': 'Sulfur.png/32px-Sulfur.png',
        'metallic asteroid reprocessing': 'Metallic_asteroid_reprocessing.png/32px-Metallic_asteroid_reprocessing.png',
        'metallic asteroid crushing': 'Metallic_asteroid_crushing.png/32px-Metallic_asteroid_crushing.png',
        'carbonic asteroid reprocessing': 'Carbonic_asteroid_reprocessing.png/32px-Carbonic_asteroid_reprocessing.png',
        'carbonic asteroid crushing': 'Carbonic_asteroid_crushing.png/32px-Carbonic_asteroid_crushing.png',
        'oxide asteroid reprocessing': 'Oxide_asteroid_reprocessing.png/32px-Oxide_asteroid_reprocessing.png',
        'oxide asteroid crushing': 'Oxide_asteroid_crushing.png/32px-Oxide_asteroid_crushing.png',
        'advanced oxide asteroid crushing': 'Advanced_oxide_asteroid_crushing.png/32px-Advanced_oxide_asteroid_crushing.png',
        'advanced carbonic asteroid crushing': 'Advanced_carbonic_asteroid_crushing.png/32px-Advanced_carbonic_asteroid_crushing.png',
        'advanced thruster fuel': 'Advanced_thruster_fuel.png/32px-Advanced_thruster_fuel.png',
        'advanced thruster oxidizer': 'Advanced_thruster_oxidizer.png/32px-Advanced_thruster_oxidizer.png',
        'straight rail': 'Straight_rail.png/32px-Straight_rail.png',
        'curved rail a': 'Curved_rail.png/32px-Curved_rail.png',
        'curved rail b': 'Curved_rail.png/32px-Curved_rail.png',
        'half diagonal rail': 'Curved_rail.png/32px-Curved_rail.png',
        'solid fuel from light oil': 'Solid_fuel_from_light_oil.png/32px-Solid_fuel_from_light_oil.png',
        'light oil cracking': 'Light_oil_cracking.png/32px-Light_oil_cracking.png',
        'heavy oil cracking': 'Heavy_oil_cracking.png/32px-Heavy_oil_cracking.png',
        'battery': 'Battery.png/32px-Battery.png',
        'advanced oil processing': 'Advanced_oil_processing.png/32px-Advanced_oil_processing.png',
        'uranium 238': 'Uranium-238.png/32px-Uranium-238.png',
        'uranium 235': 'Uranium-235.png/32px-Uranium-235.png',
        'explosives': 'Explosives.png/32px-Explosives.png',
        'jellynut processing': 'Jellynut_processing.png/32px-Jellynut_processing.png',
        'uranium fuel cell': 'Uranium_fuel_cell.png/32px-Uranium_fuel_cell.png',
        'personal roboport equipment': 'Personal_roboport.png/32px-Personal_roboport.png',
        'fission reactor equipment': 'Portable_fission_reactor.png/32px-Portable_fission_reactor.png',
        'battery mk2 equipment': 'Personal_battery_MK2.png/32px-Personal_battery_MK2.png',
        'battery equipment': 'Personal_battery.png/32px-Personal_battery.png',
        'capture robot rocket': 'Capture_bot_rocket.png/32px-Capture_bot_rocket.png',
    };
    return 'https://wiki.factorio.com/images/thumb/' + FACTORIO_ITEMS_32px[itemName.replace(/-/g, ' ')];
}
